...
/**
 * Constants file that holds all Configuration-related constants
 *
 * @author Peter Brock
...
public class Configuration {
	...
	public static final String ENV_MONGO_PORT_OPENSHIFT = "OPENSHIFT_MONGODB_DB_PORT";
	...
	public static final String ENV_BASE_URL = "LOCAL_BASE_URL";
	public static final String DEFAULT_RELATIVE_BASE_URL = "/remarc_resources/" + CONTENT_DIR;
